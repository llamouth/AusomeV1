            ...
            <Card.Body className="py-3">
                {( comment.user_id == userLoggedIn) && (
                    <div className="absolute top-2 right-2 flex space-x-2">
                        {comment.user_id == userLoggedIn && <Button variant="link" className="p-1 text-blue-500 hover:text-blue-700 transition-colors duration-200" title="Update Comment" onClick={handleEditComment}>
                            <FaEdit size={16} />
                        </Button>}
