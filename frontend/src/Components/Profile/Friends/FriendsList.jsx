...
const FriendsList = () => {
    ...
    useEffect(() => {
        const foundFriend = friends.find(friend => friend.id == userLoggedIn);
        if (foundFriend) {
    ...
    return (
        <div className="bg-white p-4  rounded-lg relative">
            ...
            <div className="absolute flex items-center px-2 py-1 rounded-full -top-9 -right-3 bg-gray-100 shadow-sm hover:cursor-pointer" onClick={() => setHandleFriendship(!handleFriendship)}>
